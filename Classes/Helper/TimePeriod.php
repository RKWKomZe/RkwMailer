 ...
 */
class TimePeriod implements \TYPO3\CMS\Core\SingletonInterface
{
     ...
     */
    public function getTimePeriod($timeFrame = 0)
    {
     ...
     */
    protected function findOutQuarter()
    {
     ...
     * @return array $quarters
     */
    protected function findOutHalfyear()
    {
