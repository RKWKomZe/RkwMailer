...
class EmailStandaloneViewTest extends FunctionalTestCase
{
    ...
    public function constructLoadsFallbackConfiguration ()
    {
        ...
        self::assertEquals(
            'EXT:rkw_mailer/Tests/Integration/View/EmailStandaloneViewTest/Fixtures/Frontend/Layouts/',
            $settings['view']['layoutRootPaths'][1]
        );
    ...
    public function addLayoutPathsMergesGivenPathsToExistingOnes ()
    {
        ...
        $expected = [
            0 => 'typo3conf/ext/rkw_mailer/Resources/Private/Layouts/',
            1 => 'typo3conf/ext/rkw_mailer/Tests/Integration/View/EmailStandaloneViewTest/Fixtures/Frontend/Layouts/',
    ...
    public function addPartialPathsMergesGivenPathsToExistingOnes ()
    {
        ...
        $expected = [
            0 => 'typo3conf/ext/rkw_mailer/Resources/Private/Partials/',
            1 => 'typo3conf/ext/rkw_mailer/Tests/Integration/View/EmailStandaloneViewTest/Fixtures/Frontend/Partials/',
    ...
    public function addTemplatePathsMergesGivenPathsToExistingOnes ()
    {
        ...
        $expected = [
            0 => 'typo3conf/ext/rkw_mailer/Resources/Private/Templates/',
            1 => 'typo3conf/ext/rkw_mailer/Tests/Integration/View/EmailStandaloneViewTest/Fixtures/Frontend/Templates/',
    ...
    public function setTemplateAddsTemplateAsFullPath()
    {
        ...
        $this->subject->setTemplate(
            'EXT:rkw_mailer/Tests/Integration/View/EmailStandaloneViewTest/Fixtures/Frontend/Templates/Testing/Test'
        );

        $resultingPaths = $this->subject->getTemplateRootPaths();
        self::assertCount(2, $resultingPaths);
        self::assertStringEndsWith(
            'typo3conf/ext/rkw_mailer/Tests/Integration/View/EmailStandaloneViewTest/Fixtures/Frontend/Templates/Testing/Test.html',
    ...
    public function setTemplateAddsTemplateAsFullPathWithGivenFileExtension()
    {
        ...
        $this->subject->setTemplate(
            'EXT:rkw_mailer/Tests/Integration/View/EmailStandaloneViewTest/Fixtures/Frontend/Templates/Testing/Test.test'
        );

        $resultingPaths = $this->subject->getTemplateRootPaths();
        self::assertCount(2, $resultingPaths);
        self::assertStringEndsWith(
            'typo3conf/ext/rkw_mailer/Tests/Integration/View/EmailStandaloneViewTest/Fixtures/Frontend/Templates/Testing/Test.test',
            $this->subject->getTemplatePathAndFilename()
        );
    }
    ...
    public function setTemplateAddsTemplateRootPathsAndAction ()
    {
        ...
        self::assertStringEndsWith(
            'typo3conf/ext/rkw_mailer/Tests/Integration/View/EmailStandaloneViewTest/Fixtures/Frontend/Templates/Testing/',
            $resultingPaths[2]
        );
        self::assertEquals('test', $this->subject->getRenderingContext()->getControllerAction());
    }
    ...
    public function renderReplacesPathMarkers()
    {
        ...
        self::assertStringContainsString('baseUrlImages: http://www.example.de/typo3conf/ext/rkw_mailer/Resources/Public/Images', $result);
