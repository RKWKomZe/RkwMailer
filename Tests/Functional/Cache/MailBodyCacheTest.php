...
class MailBodyCacheTest extends FunctionalTestCase
{
     ...
     * @test
     */
    public function setPlaintextBodyAndGetPlaintextBodyWithAnotherQueueRecipientReturnsNull()
    {
        /** @var \RKW\RkwMailer\Domain\Model\QueueRecipient $queueRecipient */
        $queueRecipient = $this->queueRecipientRepository->findbyUid(1);
        ...
        static::assertNull($this->subject->getPlaintextBody($queueRecipientTwo));
    }
     ...
     * @test
     */
    public function setHtmlBodyAndGetHtmlBodyWithAnotherQueueRecipientReturnsNull()
    {
        /** @var \RKW\RkwMailer\Domain\Model\QueueRecipient $queueRecipient */
        $queueRecipient = $this->queueRecipientRepository->findbyUid(1);
        ...
        static::assertNull($this->subject->getHtmlBody($queueRecipientTwo));
    }
     ...
     * @test
     */
    public function setCalendarBodyAndGetCalendarBodyWithAnotherQueueRecipientReturnsNull()
    {
        /** @var \RKW\RkwMailer\Domain\Model\QueueRecipient $queueRecipient */
        $queueRecipient = $this->queueRecipientRepository->findbyUid(1);
        ...
        static::assertNull($this->subject->getCalendarBody($queueRecipientTwo));
    }
